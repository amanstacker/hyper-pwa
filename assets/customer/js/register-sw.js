(function() {
		...
		if ( window.hypwaDeferredPrompt ) {
			...
			window.hypwaDeferredPrompt.userChoice.then((choiceResult) => {
				if (choiceResult.outcome === 'accepted') {
					hypwaLog('Hyper PWA: PWA installed successfully.');
				}
	...
	window.hypwaTriggerPWAInstall = hypwaTriggerPWAInstall;
	window.hypwaBindCustomInstallTriggers = hypwaBindCustomInstallTriggers;
})();